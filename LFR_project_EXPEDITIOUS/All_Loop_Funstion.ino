...
void pid_maze() {
  ...
  if (s[1] == 1 && s[12] == 0) turn_left();
  // 90 degree right
  else if (s[1] == 0 && s[12] == 1) turn_right();
  else if (s[0] == 1 && s[1] == 1 && s[2] == 1 && s[11] == 0 && s[12] == 0 && s[13] == 0) degree_left();
  else if (s[0] == 0 && s[1] == 0 && s[2] == 0 && s[11] == 1 && s[12] == 1 && s[13] == 1) degree_right();
  // 90 degree left
  else if (s[0] == 1 && s[1] == 0 && s[2] == 0 && s[3] == 0 && s[4] == 0 && (s[5] == 1 || s[6] == 1 || s[7] == 1 || s[8] == 1) && s[9] == 0 && s[10] == 0 && s[11] == 0 && s[12] == 0 && s[13] == 0) force_maze_left();
  // 90 degree right
  
  else if (s[0] == 0 && s[1] == 0 && s[2] == 0 && s[3] == 0 && s[4] == 0 && s[5] == 0 && s[6] == 0 && s[7] == 0 && s[8] == 0 && s[9] == 0 && s[10] == 0 && s[11] == 0 && s[12] == 0 && s[13] == 1) maze_right();

  // maze left
  //else if ((s[0] == 1 || s[1] == 1) && (s[4] == 1 || s[5] == 1 || s[6] == 1 || s[7] == 1 || s[8] == 1 || s[9] == 1) && (s[2] == 0 && s[3] == 0 && s[10] == 0 && s[11] == 0 && s[12] == 0 && s[13] == 0)) force_maze_left();
  // maze right  000--1111--00011
  ...
  //else if ((s[0] == 1 || s[2] == 1 || s[3] == 1) && (s[11] == 1 || s[12] == 1 || s[13] == 1)) t_junction();
  // backward
  //else if (s[0] == 0 && s[1] == 0 && s[2] == 0 && s[3] == 0 && s[4] == 0 && s[5] == 0 && s[6] == 0 && s[7] == 0 && s[8] == 0 && s[9] == 0 && s[10] == 0 && s[11] == 0 && s[12] == 0 && s[13] == 0) u_turn();
  // stop
  else if (s[0] == 1 && s[1] == 1 && s[2] == 1 && s[3] == 1 && s[4] == 1 && s[5] == 1 && s[6] == 1 && s[7] == 1 && s[8] == 1 && s[9] == 1 && s[10] == 1 && s[11] == 1 && s[12] == 1 && s[13] == 1) short_path();

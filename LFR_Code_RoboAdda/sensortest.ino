void sensorRead(int b){
  ...
  //code for taking ANALOGREAD manually 
  ...
  // Code for doing Analog to Digital manually

  // if (s1 > b) s1 = 1; //black surface
  // else s1 = 0; // white surface
  // if (s2 > b) s2 = 1; //black surface
  // else s2 = 0; // white surface
  // if (s3 > b) s3 = 1; //black surface
  // else s3 = 0; // white surface
  // if (s4 > b) s4 = 1; //black surface
  // else s4 = 0; // white surface
  // if (s5 > b) s5 = 1; //black surface
  // else s5 = 0; // white surface
  // if (s6 > b) s6 = 1; //black surface -- reciever will give high reading

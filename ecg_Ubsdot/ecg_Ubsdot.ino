...
#define WIFISSID "CUET-Students-N" // Enter WifiSSID here
#define PASSWORD "1020304050" // Enter password here
#define TOKEN "BBUS-3bt6lGdOhhsvtBHZZjYBF3kgWaaapM" // Ubidots' TOKEN
#define MQTT_CLIENT_NAME "faysaltaysir" // MQTT client Name
// * Define Constants
